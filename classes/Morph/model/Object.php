...
class Morph_Object
{
     ...
     * @return Morph_Object
     */
    protected function addProperty(Morph_Property_Generic $property, $alias = null)
    {
    ...
    public function __getData($whereNew = false)
    {
        ...
        foreach ($this->propertySet as $property) {
            ...
            if (!$whereNew) {
                ...
                if ($state === Morph_Enum::STATE_DIRTY || $state === Morph_Enum::STATE_NEW) {
                    $data[$storageName] = $property->__getRawValue();
                }
            }
        }
    ...
    public function __set($propertyName, $propertyValue)
    {
        if ( array_key_exists($propertyName, $this->propertySet)) {
            ...
            trigger_error("The property $propertyName was not found in object of class "
                    . get_class($this) . ' but I have added it as a generic property type', E_USER_WARNING);
        }
        return $this;
    }
    ...
    {
        return Morph_Storage::instance()->save($this, $options);
    }
     ...
     * @return boolean
     */
    public function deleteByQuery(Morph_IQuery $query, $safe = null)
    {
        return Morph_Storage::instance()->findByQuery($this, $query, $safe);
    }
    ...
    {
        return Morph_Storage::instance()->findByQuery($this);
    }
